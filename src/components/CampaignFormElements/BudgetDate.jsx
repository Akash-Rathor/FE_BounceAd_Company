...
const BudgetDate = ({ setBudgetAndDates }) => {
  ...
  const [data, setData] = useState({
    startDate: '', endDate: '', budgetType: '', days: 0, dailyBudget: 0, amount: 0
  });
  ...
  return (
    <div className='flex flex-col justify-evenly items-start space-y-5'>
      <div className='flex flex-row justify-evenly items-start flex-wrap'>
        <div className='flex flex-col justify-center items-start lg:w-2/3 md:w-1/3 left-0'>
        ...
        {message && <div className='flex flex-row justify-right items-right text-justify lg:w-1/3 md:w-1/3 right-5 top-2 bg-warning p-2 bg-opacity-10 rounded-lg opacity-70'>
