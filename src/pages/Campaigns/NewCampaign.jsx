...
const NewCampaign = () => {
    ...
    // const [budgeError, setBudgetError] = useState(`Your bid might be too low for your campaign settings. You can improve your campaign's potential reach and performance by adjusting your bid to ₹${mcpv}.Suggested based on your budget, campaign duration, targeting criteria, ad format, and estimated auction dynamics.`);
    const [showSkip, setShowSkip] = useState(true);

    // modal fiels and methods
                            ...
                            <div className="border border-stroke bg-white shadow-default dark:border-strokedark dark:bg-boxdark rounded-xl">
                                ...
                                <div className="flex flex-col w-full">
                                    <form action="#">
                                        ...
                                        <Accordion title='Campaign Name' value={campaignName}>
                                            <CampaignName setValueCallback={setCampaignname}/>
                                        </Accordion>

                                        <Accordion title='Bid Strategy' value={bidStrategy}>
                                            <BidStrategy setBidStrategy={setBidStrategy}/>
                                        </Accordion>

                                        <Accordion title='Budget and dates' value={budgetDateHeading}>
                                            <BudgetDate setBudgetAndDates={setBudgetAndDates}/>
                                        </Accordion>

                                        <Accordion title='Locations' value={location}>
